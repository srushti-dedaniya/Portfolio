          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {projects.map((project, index) => (
              ...
              >
                {project.imageUrl ? (
                  <div
                    className={`h-48 md:h-64 bg-cover bg-center bg-gradient-to-br transition-transform duration-500 group-hover:scale-105 ${
                ...
                <div className="p-6 flex flex-col gap-4 flex-grow">
                  ...
                  <div className="flex items-center gap-2 text-accent text-body-sm mt-2 font-medium">
